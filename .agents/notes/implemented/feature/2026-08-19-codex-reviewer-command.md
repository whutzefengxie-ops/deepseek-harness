...
- **Codex presence is a host responsibility** — a missing CLI blocks admission; authentication, JSONL, exit-code, signal, and output-limit failures settle visibly in the durable card.
