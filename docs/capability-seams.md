...
| `ctx.shadowMind` | `core` | [`shadow-mind-runtime`](../packages/shadow-mind/shadow-mind-runtime) | - | [`tool-shadow-mind`](../packages/shadow-mind/tool-shadow-mind) | - | Observes completed root tool turns, starts bounded fresh one-shot reviewers, and relays accepted durable reports; the management plugin consumes its definition, settings, and per-root control APIs. |
