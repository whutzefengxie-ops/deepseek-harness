...
| [shadow-mind.md](shadow-mind.md) | probabilistic root-only background analysis: Markdown definitions, reasoning-free trajectory projection, fresh Shadow runs, durable report relay, settings, status, and Web administration |
