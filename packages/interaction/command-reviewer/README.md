...
| `teardownTimeoutMs` | `10000` | Maximum milliseconds from Agent or plugin teardown through process-tree exit confirmation and lifecycle persistence; bounded by the Node timer maximum. |
