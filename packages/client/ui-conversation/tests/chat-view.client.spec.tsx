...
function makeHarness(init?: Partial<ConversationSnapshot>) {
  ...
  const renderContextSlot = ((_key: string, _owner: object, opts?: { fallback?: React.ReactNode }) =>
    opts?.fallback ?? null) as unknown as React.ComponentProps<typeof ContextMessageNodeView>['renderSlot']
