...
import { REVIEWER_NS, ReviewerCardController } from './reviewer-card-controller.ts'
...
export type { ReviewerCardProps } from './ReviewerCard.tsx'
...
export type { ReviewerCardFace, ReviewerCardState } from './reviewer-card-controller.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  const reviewer = new ReviewerCardController(ctx.settingsScope.bind({ namespace: REVIEWER_NS }))
