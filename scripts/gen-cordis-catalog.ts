...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SpillRef: 'spill.md',
  ActiveShadowStatus: 'shadow-mind.md',
  CreateShadowDefinition: 'shadow-mind.md',
  ShadowAdministrationSnapshot: 'shadow-mind.md',
  ShadowCatalog: 'shadow-mind.md',
  ShadowDefinition: 'shadow-mind.md',
  ShadowDefinitionInput: 'shadow-mind.md',
